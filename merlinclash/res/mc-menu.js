...
function menu_hook() {
	tabtitle[tabtitle.length - 1] = new Array("", "科学上网设置", "__INHERIT__");
	tablink[tablink.length - 1] = new Array("", "Module_merlinclash.asp",  "NULL");
}
...
function openmcHint(itemNum) {
	...
	if (itemNum == 1) {
		statusmenu = "如果想修改预置方案，文件存放位置在：/jffs/softcenter/merlinclash/yaml;redir-host为redirhost.yaml;fake-ip为fakeip.yaml";
		_caption = "DNS方案说明";
		width = "350px";
	}
	if (itemNum == 2) {
